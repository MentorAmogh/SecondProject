...
##/CollaborationBackEndJava/src/main/java/com/niit/collaborationbackend##
	...
	**DAO**
		...
		*b)EventMasterDAO_Impl.java*
		*c)ForumCategoryDAO_Impl.java*
		*d)FriendsDAO_Impl.java
		*JobDAO_Impl.java
...
##The frontend contains following directory structure##
	**/CollaborationFrontEndJava/src/main/webapp**
		...
		**v_friend**
			...
			*frmAllUsers.html
			*frmForum.html
			*frmPendingRequest.html#Project developed by *Mentor Amogh Chitnis* ad part of DT Evaluation process#
